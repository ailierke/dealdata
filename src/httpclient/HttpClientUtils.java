...
//		InetAddress[] inte = InetAddress.getAllByName("kh.google.com");
//		if(inte!=null){
//			for(int i = 0;i<inte.length;i++){
//				System.out.println(inte[i].getHostAddress());
//			}
//		}
//		System.out.println(simpleGetInvoke("http://www.baidu.com", new HashMap<String, String>()));
		System.out.println(simplePostInvoke("http://kh.google.com/geauth", new HashMap<String, String>()));
	}
}